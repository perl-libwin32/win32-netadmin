...
die "The Win32::NetAdmin module works only on Windows NT"
...
sub AUTOLOAD {
    ...
    if ($! != 0) {
        if ($! =~ /Invalid/) {
            ...
            die
                "Your vendor has not defined Win32::NetAdmin macro $constname, used in $file at line $line.";
        }
    }
...
our $SidTypeDomain         = 3;
our $SidTypeAlias          = 4;
our $SidTypeWellKnownGroup = 5;
our $SidTypeDeletedAccount = 6;
our $SidTypeInvalid        = 7;
our $SidTypeUnknown        = 8;
